...
w, _ = eigen(Matrix(mat(hamiltonian(10,9.45))))

# ╔═╡ ff8d6aba-5369-4ca0-ab87-63810e2c8f84
delta_n = [w[i+1] - w[i] for i in 1:16-1]

# ╔═╡ e9e7d2d5-d5df-4f3f-aeba-9f3ed8ba51e4
delta_nplus1 = [w[i+2]-w[i+1] for i in 1:16-2]
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "da788258b7b4d4606ae9e125ede3c5ab6d79c8b8"
